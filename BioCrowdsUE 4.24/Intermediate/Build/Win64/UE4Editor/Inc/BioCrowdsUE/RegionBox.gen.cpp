...
// End Cross Module References
	...
	struct Z_Construct_UClass_ARegionBox_Statics
	{
		...
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_Flags_Inner;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_ARegionBox_Statics::NewProp_Flags_Inner = { "Flags", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ARegionBox_Statics::NewProp_Flags_MetaData[] = {
		{ "Category", "SetUp" },
		{ "ModuleRelativePath", "src/RegionBox.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ARegionBox_Statics::NewProp_Flags = { "Flags", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARegionBox, Flags), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ARegionBox_Statics::NewProp_Flags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARegionBox_Statics::NewProp_Flags_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ARegionBox_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ARegionBox_Statics::NewProp_Flags_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ARegionBox_Statics::NewProp_Flags,
	};
	...
	IMPLEMENT_CLASS(ARegionBox, 1740555355);
